...
function listLectures() {
	...
	axios
		.get(`${apiPath}api/v1/getDeanLectures`, {
			headers: {
				Authorization: token,
			},
		})
			        ...
			        <div class="card-header bg-white" id="block_${item._id}">
			            <div class="media">
			                <div class="media-left media-middle">
			                    <a href="edit_course.html?${item._id},${item.meetingId}">
			                ...
			                <div class="media-right media-middle">
			                    <a href="edit_course.html?${item._id},${item.meetingId}" class=""><i class="fa fa-pencil"></i></a>
			                    <a class="delete" id="delete_${item._id}" dir="${item.meetingId}"><i class="fa fa-trash" style="color:red;"></i></a>
			                </div>
			            </div>
			        </div>
			    </div>`;
...
function delete_lecture(id, mId) {
	...
	axios
		.delete(`${apiPath}api/v1/deleteLecture`, {
